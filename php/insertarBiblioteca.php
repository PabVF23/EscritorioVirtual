    ...
    <main>
        ...
        <?php
            if (isset($_POST['confirmarLibro'])) {
                ...
                $biblioteca->insertarLibro($autor, $titulo, $genero, $año);
            } else {
        ...
        <?php
            if (isset($_POST['confirmarCliente'])) {
                ...
                $biblioteca->insertarCliente($dni, $nombre, $apellidos);
            } else {
        ...
        <?php
            if (isset($_POST['confirmarEmpleado'])) {
                ...
                $biblioteca->insertarEmpleado($idEmpleado, $nombre, $apellidos);
            } else {
        ...
        <?php
            if (isset($_POST['confirmarDevolucion'])) {
                ...
                $biblioteca->insertarDevolucion($dniCliente, $idEmpleado, $autor, $titulo, $fecha, $sancion);
            } else {
